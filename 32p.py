...
from data.p_data_load import process_plain_data
from model.model_32 import EffNetB0
...
dicom_tensors, status_tensors, patients, days = process_plain_data(data_path, name_status, name_days)
